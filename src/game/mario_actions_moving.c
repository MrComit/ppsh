...
struct GrindPoints grind14[11] = {
    {{-27645.85f, -10177.65f, -10961.85f}, 1, 1, 0x0000},
    {{-27886.6f, -10103.7f, -10970.7f}, 2, 2, 0x0000},
    {{-29856.85f, -10103.7f, -11043.25f}, 3, 3, 0x0000},
    {{-30745.0f, -10103.7f, -12413.45f}, 4, 4, 0x0000},
    {{-31142.1f, -10103.7f, -14243.4f}, 5, 5, 0x0000},
    {{-31422.3f, -10103.7f, -17051.0f}, 6, 6, 0x0000},
    {{-31537.9f, -10103.7f, -19291.1f}, 7, 7, 0x0000},
    {{-31019.05f, -10103.7f, -21293.85f}, 8, 8, 0x0000},
    {{-29526.7f, -10103.7f, -21792.3f}, 9, 9, 0x0000},
    {{-28997.2f, -10103.7f, -21792.3f}, 10, 10, 0x0000},
    {{-28838.6f, -10152.65f, -21792.3f}, -2, -2, 0x0000},
};

struct GrindPoints grind15[5] = {
    {{-28316.3f, -10177.65f, -21792.3f}, 1, -2, 0x4000},
    {{-28066.3f, -10103.7f, -21792.3f}, 2, 0, 0x4000},
    {{-26639.85f, -9365.2f, -21792.3f}, 3, 1, 0x4000},
    {{-24776.75f, -9365.2f, -21792.3f}, 4, 2, 0x4000},
    {{-23350.3f, -10103.7f, -21792.3f}, -1, 3, 0x4000},
};

struct GrindPoints grind16[20] = {
    {{-22546.25f, -10099.65f, -21792.75f}, 1, -1, 0x4000},
    {{-22055.75f, -10099.65f, -21792.75f}, 2, 0, 0x4000},
    {{-22055.75f, -10099.65f, -21378.55f}, 3, 1, 0x0000},
    {{-22055.75f, -10362.5f, -20248.4f}, 4, 2, 0x0000},
    {{-22055.75f, -10099.65f, -19118.25f}, 5, 3, 0x0000},
    {{-22055.75f, -9827.45f, -18553.2f}, 6, 4, 0x0000},
    {{-22055.75f, -9641.6f, -17988.1f}, 7, 5, 0x0000},
    {{-22055.75f, -9782.8f, -17427.95f}, 8, 6, 0x0000},
    {{-22055.75f, -10099.65f, -16857.95f}, 9, 7, 0x0000},
    {{-22055.75f, -10265.2f, -16292.85f}, 10, 8, 0x0000},
    {{-22055.75f, -10388.05f, -15727.8f}, 11, 9, 0x0000},
    {{-22055.75f, -10456.0f, -15162.7f}, 12, 10, 0x0000},
    {{-22055.75f, -10315.1f, -14597.65f}, 13, 11, 0x0000},
    {{-22055.75f, -10099.65f, -14032.55f}, 14, 12, 0x0000},
    {{-22055.75f, -9827.1f, -13467.5f}, 15, 13, 0x0000},
    {{-22055.75f, -9900.85f, -12902.4f}, 16, 14, 0x0000},
    {{-22055.75f, -10099.65f, -11904.65f}, 17, 15, 0x0000},
    {{-22055.75f, -10099.65f, -11097.85f}, 18, 16, 0x0000},
    {{-22386.0f, -10099.65f, -11097.85f}, 19, 17, 0xC000},
    {{-23265.5f, -9507.9f, -11097.85f}, -1, 18, 0xC000},
};

struct GrindPoints grind17[6] = {
    {{-24174.7f, -9035.15f, -11097.85f}, 1, -1, 0xC000},
    {{-24562.65f, -9035.15f, -11097.85f}, 2, 0, 0xC000},
    {{-25013.35f, -8668.35f, -11097.85f}, 3, 1, 0xC000},
    {{-25464.1f, -8668.35f, -11097.85f}, 4, 2, 0xC000},
    {{-25914.8f, -9035.15f, -11097.85f}, 5, 3, 0xC000},
    {{-26302.75f, -9035.15f, -11097.85f}, -1, 4, 0xC000},
};

struct GrindPoints grind18[21] = {
    {{-24807.95f, -10103.7f, -18960.8f}, 1, 1, 0x0000},
    {{-24807.95f, -10103.7f, -17876.9f}, 2, 2, 0x0000},
    {{-25191.75f, -10103.7f, -17157.35f}, -2, -2, 0x0000},

    {{-25421.75f, -10103.7f, -16738.7f}, 4, 4, 0x0000},
    {{-25638.55f, -10103.7f, -16513.65f}, 5, 5, 0x0000},
    {{-25725.35f, -10103.7f, -16064.45f}, 6, 6, 0x0000},
    {{-25547.2f, -10103.7f, -15726.65f}, 7, 7, 0x0000},
    {{-25067.9f, -10103.7f, -15537.95f}, -2, -2, 0x0000},

    {{-24653.55f, -10103.7f, -15394.2f}, 9, 9, 0x0000},
    {{-24185.55f, -10103.7f, -15236.15f}, 10, 10, 0x0000},
    {{-24070.6f, -10103.7f, -14664.2f}, 11, 11, 0x0000},
    {{-24216.9f, -10103.7f, -14262.15f}, 12, 12, 0x0000},
    {{-23955.3f, -10103.7f, -13999.2f}, -2, -2, 0x0000},

    {{-23719.9f, -10103.7f, -13766.6f}, 14, 14, 0x0000},
    {{-23106.25f, -10103.7f, -13359.35f}, 15, 15, 0x0000},
    {{-23167.65f, -10103.7f, -12715.4f}, 16, 16, 0x0000},
    {{-23877.95f, -10103.7f, -12512.8f}, 17, 17, 0x0000},
    {{-24371.8f, -10103.7f, -12574.15f}, -2, -2, 0x0000},

    {{-24715.45f, -10103.7f, -12607.65f}, 19, 19, 0x0000},
    {{-25309.35f, -10103.7f, -12889.1f}, 20, 20, 0x0000},
    {{-25816.2f, -10103.7f, -13180.55f}, -2, -2, 0x0000},
};
...
struct GrindPoints *grindTrajectories[] = {
    ...
    grindF, grind10, grind11, grind12, grind13, grind14, grind15, grind16, grind17, grind18,
};

u16 grindLengths[] = {
    2, 6, 4, 2, 14, 2, 2, 4, 2, 2, 3, 3, 5, 2, 3, 2, 2, 3, 4, 5, 11, 5, 20, 6, 21,
};
