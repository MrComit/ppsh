...
Vec3f gCCPosTable[] = {
    ...
    {-28311.15f, -8490.8f, -658.54f}, {-24380.35f, 13124.7f, -2859.875f}, {0.0f, 2391.33f, 3864.28f},
    {0.0f, 500.0f, 1000.0f},
};
Vec3f gCCFocTable[] = {
    {-13487.0f, 0.0f, 4561.0f}, {1410.0f, 1965.0f, 2435.0f}, {22516.75f, -9148.7f, -651.235f},
    {-31020.0f, -9243.3f, -658.54f}, {-19487.75f, 9551.2f, -10190.0f}, {0.0f, 300.0f, 273.215f},
    {0.0f, 0.0f, 3000.0f},
};
...
u8 sZoomOutAreaMasks[] = {
	...
	ZOOMOUT_AREA_MASK(1, 1, 1, 1, 0, 0, 0, 0), // LLL            | DDD
