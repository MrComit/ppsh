...
DEFINE_LEVEL("YYAMA1 % YSLD1", LEVEL_CCM, COURSE_CCM, ccm, snow, 20000, 0x20, 0x00, 0x00, _, sCamCCM) 
...
DEFINE_LEVEL("BATTLE FIELD", LEVEL_BOB, COURSE_BOB, bob, generic, 20000, 0x00, 0x00, 0x48, sDynII, sCamBOB) 
...
DEFINE_LEVEL("MOUNTAIN", LEVEL_WF, COURSE_WF, wf, grass, 20000, 0x00, 0x00, 0x00, sDynCC, sCamWF) 
DEFINE_LEVEL("ENDING", LEVEL_ENDING, COURSE_CAKE_END, ending, generic, 20000, 0x00, 0x00, 0x00, _, _) 
DEFINE_LEVEL("URANIWA", LEVEL_CASTLE_COURTYARD, COURSE_NONE, castle_courtyard, outside, 20000, 0x4C, 0x4C, 0x4C, _, sCamCastleCourtyard) 
