...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		OBJECT(MODEL_SIMP_TOAD, 568, 12835, -22640, 0, 90, 0, 0x00020000, bhvGangToad),
		OBJECT(MODEL_SIMP_TOAD, 2133, -10000, 12738, 0, -90, 0, 0x00010000, bhvGangToad),
		OBJECT(MODEL_SIMP_TOAD, -7349, -10000, 23800, 0, -90, 0, 0x00000000, bhvGangToad),
		OBJECT(MODEL_GATE, 22517, -10000, -651, 0, 0, 0, 0x00000000, bhvTimedGate),
		OBJECT_WITH_ACTS(MODEL_NONE, 0, -9041, 26663, 0, -180, 0, 0x000A0000, bhvWarps78, 0),
		...
		OBJECT(MODEL_NONE, 262, 13424, -18440, 0, -180, 0, 0x000A0000, bhvWarps78),
		OBJECT(MODEL_TOAD, -26907, -10178, -12692, 0, 0, 0, 0x00000000, bhvSimpMGToad),
		...
		OBJECT(MODEL_STAR_PIECE, -24809, -9866, -15419, 0, 0, 0, 0x00010000, bhvStarPiece),
		OBJECT(MODEL_STAR_PIECE, -25963, -9866, -13318, 0, 0, 0, 0x00010000, bhvStarPiece),
		OBJECT(MODEL_STAR_PIECE, -23876, -9866, -13846, 0, 0, 0, 0x00010000, bhvStarPiece),
		OBJECT(MODEL_STAR_PIECE, -24559, -9866, -12569, 0, 0, 0, 0x00010000, bhvStarPiece),
		OBJECT(MODEL_STAR_PIECE, -25298, -9866, -16919, 0, 0, 0, 0x00010000, bhvStarPiece),
		OBJECT(MODEL_NONE, -26383, -9878, -15253, 0, 0, 0, 0x00000000, bhvStarPieceStar),
	...
	AREA(2, jrb_area_2),
		...
		OBJECT(MODEL_SIMP_ELEVATOR, 0, -8297, -18018, 0, 0, 0, 0x00000000, bhvSCElevator),
