...
const LevelScript level_jrb_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_SIMP_DOOR, simp_door_geo), 
	...
	AREA(1, jrb_area_1),
		...
		WARP_NODE(0xF1, LEVEL_JRB, 0x01, 0x0F, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF3, LEVEL_JRB, 0x01, 0x0F, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, 576, 13322, -14206, 0, -180, 0, 0x000F0000, bhvWarps84),
		OBJECT(MODEL_SIMP_DOOR, 24731, -2571, 20867, 0, 0, 0, 0x00000000, bhvSecretDoor),
		...
		OBJECT(MODEL_HINT_TOAD, 1545, -10000, 8123, 0, -45, 0, 0x00000000, bhvHintToad),
		...
		OBJECT(MODEL_NONE, 24742, -3190, 20867, 0, -90, 0, 0x009E0000, bhvMessagePanel),
	...
	AREA(2, jrb_area_2),
		...
		WARP_NODE(0x0F, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_JRB, 0x02, 0x0F, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -2932, -679, -16942, 0, 90, 0, 0x000F0000, bhvWarps84),
		OBJECT(MODEL_SIMP_ELEVATOR, 0, -8297, -15422, 0, 0, 0, 0x00000000, bhvSCElevator),
		OBJECT(MODEL_SIMP_TOAD, 26025, -3190, 19027, 0, 0, 0, 0x00040000, bhvGangToad),
	...
	AREA(3, jrb_area_3),
		...
		WARP_NODE(0x0F, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_JRB, 0x03, 0x0F, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -17421, 18707, -7370, 0, -180, 0, 0x000F0000, bhvWarps84),
	...
	AREA(4, jrb_area_4),
		...
		OBJECT(MODEL_SUBWAY_KOOPA, 23040, -9382, -18103, 0, 0, 0, 0x008C0000, bhvSubwayKoopa),
	...
	AREA(5, jrb_area_5),
		...
		WARP_NODE(0x0F, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_JRB, 0x05, 0x0F, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, -21711, -1732, 19295, 0, -180, 0, 0x000F0000, bhvWarps84),
