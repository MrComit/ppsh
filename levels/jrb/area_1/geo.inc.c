...
const GeoLayout jrb_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 4623, -10089, 9395, jrb_dl_Sprinkler_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 7123, -10089, 9395, jrb_dl_Sprinkler_001_mesh),
