...
const GeoLayout jrb_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -1784, -9944, 2571, jrb_dl_BounceBox_mesh),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 17833, 143, 2989, jrb_dl_Building_033_mesh),
