...
const GeoLayout castle_inside_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 1075, 501, -1484, castle_inside_dl_node_003_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -3139, 479, -1424, castle_inside_dl_node_004_mesh),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
