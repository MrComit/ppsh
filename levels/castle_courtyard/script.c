...
const LevelScript level_castle_courtyard_entry[] = {
	...
	AREA(1, castle_courtyard_area_1),
		...
		MACRO_OBJECTS(castle_courtyard_area_1_Area1_macro_objs),
		STOP_MUSIC(0),
	...
	AREA(2, castle_courtyard_area_2),
		...
		MACRO_OBJECTS(castle_courtyard_area_2_Area2_macro_objs),
		STOP_MUSIC(0),
		TERRAIN_TYPE(TERRAIN_STONE),
	END_AREA(),
	...
	AREA(3, castle_courtyard_area_3),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, 5544, 184, 238, 0, 0, 0, 0x005F0000, bhvMessagePanel),
		OBJECT(MODEL_NONE, 5544, 484, -61, 0, 0, 0, 0x27030000, bhvBonusStar),
		...
		MACRO_OBJECTS(castle_courtyard_area_3_Area3_macro_objs),
		STOP_MUSIC(0),
		TERRAIN_TYPE(TERRAIN_STONE),
	END_AREA(),
