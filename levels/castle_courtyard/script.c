...
const LevelScript level_castle_courtyard_entry[] = {
	...
	AREA(1, castle_courtyard_area_1),
		...
		OBJECT(MODEL_WOODEN_SIGNPOST, 0, 184, 238, 0, 0, 0, 0x005E0000, bhvMessagePanel),
		OBJECT(MODEL_NONE, 0, 484, -61, 0, 0, 0, 0x24000000, bhvBonusStar),
		OBJECT(MODEL_NONE, 0, 50, 2698, 0, -180, 0, 0x000A0000, bhvWarps78),
		OBJECT(MODEL_NONE, 0, 50, -2698, 0, 0, 0, 0x000B0000, bhvWarps78),
