...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		WARP_NODE(0x97, LEVEL_CASTLE_COURTYARD, 0x01, 0x0B, WARP_NO_CHECKPOINT),
		WARP_NODE(0xAB, LEVEL_CASTLE_COURTYARD, 0x02, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xCA, LEVEL_BOB, 0x01, 0xCA, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_SIMP_TOAD, -15978, 6, 7304, 0, -167, 0, 0x71000000, bhvGangToad),
		OBJECT(MODEL_SIMP_TOAD, -5188, 5894, -7657, 0, 167, 0, 0x7A000000, bhvGangToad),
		OBJECT(MODEL_MONTY_MOLE, -19647, -539, 2770, 0, -151, 0, 0x02310000, bhvMoleNpc),
		OBJECT(MODEL_MONTY_MOLE, -16117, 0, -9978, 0, 50, 0, 0x03590000, bhvMoleNpc),
		OBJECT(MODEL_MONTY_MOLE, -17308, 0, -10046, 0, 50, 0, 0x045B0000, bhvMoleNpc),
		OBJECT(MODEL_CANYON_BUTTON, -6047, 0, -24598, 0, 0, 0, 0x0C000000, bhvCanyonButton),
		OBJECT(MODEL_CANYON_BUTTON, 18689, 0, -13499, 0, 0, 0, 0x00000000, bhvBlueCanyonButton),
		...
		OBJECT(MODEL_NONE, -13811, 0, -9179, 0, 106, 0, 0x00020000, bhvCoinFormation),
		OBJECT(MODEL_NONE, -1284, 3929, -7852, 0, 106, 0, 0x00020000, bhvCoinFormation),
		OBJECT(MODEL_NONE, -654, 1965, -968, 0, 106, 0, 0x00020000, bhvCoinFormation),
		OBJECT(MODEL_NONE, -7491, 0, 6293, 0, 106, 0, 0x00020000, bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, -17171, 680, -8512, 0, 169, 0, 0x00CA0000, bhvWarps78),
		...
		OBJECT(MODEL_RED_COIN, 2622, 2691, 5448, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -17795, 1965, 1760, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 1832, 1965, -431, 0, 0, 0, 0x00000000, bhvRedCoin),
		...
		OBJECT(MODEL_RED_COIN, 1156, 2645, 6881, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 5549, 1965, 4067, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -17730, 2279, -5187, 0, 0, 0, 0x00000000, bhvRedCoin),
		...
		OBJECT(MODEL_TRUCK, 2159, 4228, -6997, 0, -81, 0, 0x00000000, bhvStaticObject),
		...
		OBJECT(MODEL_WRENCH, -15546, 0, 7176, 0, 0, 0, 0x00000000, bhvWrenchCollect),
		OBJECT(MODEL_WRENCH, -13722, 0, 11173, 0, 17, 0, 0x00000000, bhvWrenchCollect),
		OBJECT(MODEL_WRENCH, -8053, 261, 3684, 0, 0, 0, 0x00000000, bhvWrenchCollect),
		OBJECT(MODEL_WRENCH, -8271, 1021, 13022, 0, 0, 0, 0x00000000, bhvWrenchCollect),
		OBJECT(MODEL_YELLOW_COIN, -19291, 0, -6565, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 11909, 1965, 11751, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 11061, 1965, 12692, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 11499, 1965, 13592, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 12683, 1965, 14053, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_YELLOW_COIN, 10800, 1965, 16780, 0, 0, 0, 0x00000000, bhvOneCoin),
		OBJECT(MODEL_NONE, -16607, 6, 5979, 0, 75, 0, 0x003D0000, bhvSignOnWall),
	...
	AREA(2, wf_area_2),
		...
		WARP_NODE(0xF1, LEVEL_WF, 0x02, 0x4B, WARP_NO_CHECKPOINT),
		WARP_NODE(0x4B, LEVEL_BOB, 0x01, 0x4B, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 13788, 300, 4826, 0, 133, 0, 0x004B0000, bhvWarps84),
	...
	AREA(3, wf_area_3),
		WARP_NODE(0x1A, LEVEL_WF, 0x01, 0x1F, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_WF, 0x03, 0x4B, WARP_NO_CHECKPOINT),
		WARP_NODE(0x4B, LEVEL_BOB, 0x01, 0x4B, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_MONTY_MOLE, 2990, -74, 14603, 0, 42, 0, 0x01320000, bhvMoleNpc),
		OBJECT(MODEL_NONE, -1506, 554, 14509, 0, 90, 0, 0x004B0000, bhvWarps84),
	...
	AREA(4, wf_area_4),
		WARP_NODE(0x0A, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_WF, 0x04, 0x4B, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, -3226, 4320, 21279, 0, -180, 0, 0x004B0000, bhvWarps84),
