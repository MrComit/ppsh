...
const Gfx mat_canyon_button_Button_3[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, ENVIRONMENT, 0, 0, 0, 0, ENVIRONMENT, TEXEL0, 0, ENVIRONMENT, 0, 0, 0, 0, ENVIRONMENT),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureLUT(G_TT_RGBA16),
	...
	gsDPSetTileSize(0, 0, 0, 124, 124),
	gsSPSetLights1(canyon_button_Button_lights),
	gsDPSetEnvColor(255, 142, 127, 255),
	gsSPEndDisplayList(),
};

const Gfx mat_revert_canyon_button_Button_3[] = {
	gsDPPipeSync(),
	gsDPSetTextureLUT(G_TT_NONE),
	gsSPEndDisplayList(),
};
...
const Gfx canyon_button_layer1button_mesh_3[] = {
	gsSPDisplayList(mat_canyon_button_Button_3),
	gsSPDisplayList(canyon_button_layer1button_mesh_tri_0),
	gsSPDisplayList(mat_revert_canyon_button_Button_3),
	gsSPEndDisplayList(),
};
...
const Gfx canyon_button_layer2button_mesh_3[] = {
	gsSPDisplayList(mat_canyon_button_Button_3),
	gsSPDisplayList(canyon_button_layer2button_mesh_tri_0),
	gsSPDisplayList(mat_revert_canyon_button_Button_3),
	gsSPEndDisplayList(),
