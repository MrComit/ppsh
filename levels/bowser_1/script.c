...
const LevelScript level_bowser_1_entry[] = {
    ...
    AREA(/*index*/ 1, bowser_1_geo_0000D0),
        ...
        WARP_NODE(/*id*/ 0xF0, /*destLevel*/ LEVEL_JRB, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
        WARP_NODE(/*id*/ 0xF1, /*destLevel*/ LEVEL_BOWSER_1, /*destArea*/ 0x01, /*destNode*/ 0x0A, /*flags*/ WARP_NO_CHECKPOINT),
