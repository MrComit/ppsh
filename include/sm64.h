...
#define ACT_GRIND                      0x0400047B // (0x079 | ACT_FLAG_MOVING)
...
/* custom */
#define ACT_DOLPHIN_JUMP               0x0100088B // (0x08B | ACT_FLAG_AIR | ACT_FLAG_SWIMMING | ACT_FLAG_ALLOW_VERTICAL_WIND_ACTION)
...
#define ACT_DASH_ATTACK                0x300024D7// (0x0D7 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
#define ACT_DASH_ATTACK_END            0x300024D8// (0x0D8 | ACT_FLAG_MOVING | ACT_FLAG_SWIMMING | ACT_FLAG_SWIMMING_OR_FLYING | ACT_FLAG_WATER_OR_TEXT)
...
#define ACT_METAL_WATER_STANDING       0x084042F0 // (0x0F0 | ACT_FLAG_STATIONARY | ACT_FLAG_IDLE | ACT_FLAG_METAL_WATER | ACT_FLAG_PAUSE_EXIT)
#define ACT_HOLD_METAL_WATER_STANDING  0x084042F1 // (0x0F1 | ACT_FLAG_STATIONARY | ACT_FLAG_METAL_WATER | ACT_FLAG_PAUSE_EXIT)
#define ACT_METAL_WATER_WALKING        0x000044F2 // (0x0F2 | ACT_FLAG_MOVING | ACT_FLAG_WALKING | ACT_FLAG_METAL_WATER)
