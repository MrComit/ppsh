...
const BehaviorScript bhvKoopaNpc[] = {
    ...
    SET_INTERACT_TYPE(INTERACT_TEXT),
    DROP_TO_FLOOR(),
    SET_HITBOX(/*Radius*/ 120, /*Height*/ 60),
    ANIMATE(7),
    SCALE(150),
    SET_INT(oBobombBuddyRole, 0),
...
const BehaviorScript bhvMoleNpc[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_HOLDABLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, monty_mole_seg5_anims_05007248),
    SET_INTERACT_TYPE(INTERACT_TEXT),
    ...
    SET_HOME(),
    CALL_NATIVE(bhv_bobomb_buddy_init),
    //CALL_NATIVE(bhv_mole_npc_init),
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(bhv_mole_npc_loop),
    END_LOOP(),
};


/*const BehaviorScript bhvCanyonElevator[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    LOAD_COLLISION_DATA(XXXXXXXXXXXXXXXXXXXXXXX),
    SET_FLOAT(oDrawingDistance, 0x3000),
    SET_FLOAT(oCollisionDistance, 0xD00),
    SET_HOME(),
    BEGIN_LOOP(),
...
const BehaviorScript bhvCanyonButton[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
...
const BehaviorScript bhvTimedCarSwitch[] = {
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_INT(oAnimState, 1),
    LOAD_COLLISION_DATA(big_switch_collision),
    SET_FLOAT(oDrawingDistance, 0x4000),
    SET_FLOAT(oCollisionDistance, 0x600),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_purple_switch_loop),
...
const BehaviorScript bhvGangToad[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_COMPUTE_DIST_TO_MARIO /*| OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW*/ | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, simptoad_seg6_anims_0600FB58),
    ANIMATE(6),
...
const BehaviorScript bhvSimpToadMinion[] = {
    ...
    LOAD_ANIMATIONS(oAnimations, simptoad_seg6_anims_0600FB58),
    ANIMATE(8),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag*/ 0, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_FLOAT(oDrawingDistance, 0x4000),
    SET_INT(oIntangibleTimer, 0),
    SET_HOME(),
